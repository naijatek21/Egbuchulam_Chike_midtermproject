...
DECLARE @salt NVARCHAR(64) = N'seed-043'; -- change to reshuffle deterministically
...
SELECT * INTO AliceBakery        FROM #Ordered WHERE rn BETWEEN 1   AND 60;
SELECT * INTO BobsBreakfast      FROM #Ordered WHERE rn BETWEEN 61  AND 120;
SELECT * INTO CharliesCafe       FROM #Ordered WHERE rn BETWEEN 121  AND 180;
SELECT * INTO Desayuno_de_David  FROM #Ordered WHERE rn BETWEEN 181 AND 240;
SELECT * INTO EddiesEats         FROM #Ordered WHERE rn BETWEEN 241 AND 300;
